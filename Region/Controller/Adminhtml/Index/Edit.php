...
class Edit extends \Cowell\Region\Controller\Adminhtml\Action implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('cowell_region_index', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getDefaultName() : __('New Region'));
        return $resultPage;
    }
}
